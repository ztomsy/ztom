...
bot = ztom.Bot("../_config_bittrex.json", "bittrex_test.log")
...
def test_trade(start_cur, dest_cur, start_amount):
    ...
    # fix! Bittex return NULL if free balance = 0 and raising KeyError
    try:
        init_balance[dest_cur] = balance[dest_cur]
    except KeyError as e:
        init_balance[dest_cur] = 0
        pass
    ...
    price = order_book.get_depth_for_destination_currency(start_amount, dest_cur).total_price # * 1.01
